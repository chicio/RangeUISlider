#
#  Be sure to run `pod spec lint RangeUISlider.podspec' to ensure this is a
...
A highly customizable iOS range selection slider, developed using autolayout and completely customizable using IBDesignabled and IBInspectable.
  ...
  s.screenshots  = "https://raw.githubusercontent.com/chicio/RangeUISlider/master/Screenshots/01-mixed.gif"
  ...
  s.source_files  = "RangeUISlider", "RangeUISlider/**/*.{h,m}"
  s.exclude_files = "RangeUISlider/Exclude"
